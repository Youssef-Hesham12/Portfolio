        ...
        <>
            <motion.div
                ...
                <motion.a
                    ...
                    target='_blank' href="https://github.com/Youssef-Hesham12" className={isDarkMode ? 'w-max darkHover flex items-center justify-center gap-2 text-gray-700 border-[0.5px] border-gray-700 rounded-full py-3 px-10 mx-auto my-14 duration-500  dark:text-white dark:border-white' : 'w-max flex items-center justify-center gap-2 text-gray-700 border-[0.5px] border-gray-700 rounded-full py-3 px-10 mx-auto my-14 duration-500 bgg '}>
