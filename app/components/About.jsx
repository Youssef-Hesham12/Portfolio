        ...
        <>
            <motion.div
                ...
                >
                    ...
                    >
                        <p className='my-10 max-w-full Ovo text-center'>Skilled Front-End Developer with expertise in React  Next.js HTML5, CSS3, JavaScript, Bootstrap, Tailwind, Sass, Typescript and jQuery ,data structure, algorithm . Passionate about creating responsive, user-friendly applications and eager to learn new technologies. Strong team player with excellent problem-solving and communication skills.</p>
                        <motion.ul
                            initial={{ opacity: 0 }}
                            whileInView={{ opacity: 1 }}
